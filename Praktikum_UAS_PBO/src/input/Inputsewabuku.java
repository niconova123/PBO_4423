...
import interfaces.Interfacesewabuku; /*Untuk memanggil InterfaceSewaBuku.java dalam package Interfaces*/
    ...
    public List<Mtable> GetAll() {
     ...
     try{
         ...
         System.out.println("Error");
             ...
             Logger.getLogger(Inputsewabuku.class.getName()).log(Level.SEVERE, null, ex);
         }
